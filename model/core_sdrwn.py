...
if __name__ == '__main__':
    ...
    print(f"exp2 - Ablation Variants of SongDriver: Remove Weighted Note Flag")

    train_dataset = AiMusicDataset('dataset/all-half.pre.2.txt', 'data/melody_to_id.json', 'data/chord_to_id.json', args)
