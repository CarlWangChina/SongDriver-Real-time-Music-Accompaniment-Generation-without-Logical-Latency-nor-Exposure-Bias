...
if __name__ == '__main__':
    ...
    print(f"exp3 - Ablation Variants of SongDriver: Remove Structural Chord")

    train_dataset = AiMusicDataset('dataset/all-half.pre.3.txt', 'data/melody_to_id.json', 'data/chord_to_id.json', args)
