...
class Encoder(nn.Module):
    ...
    def forward(self, enc_inputs, keys):
        ...
        '''
        # weighted_features = pushMelody()
        # [batch_size, src_len, d_model-1]
        # enc_i_size = torch.Size([enc_inputs.size()[0], enc_inputs.size()[1], enc_inputs.size()[2]]))
        ...
        for idx1, bar in enumerate(enc_outputs):
            ...
            for idx2, emb_vec in enumerate(bar):
                ...
                # print(f"emb_vec_size:{emb_vec.size()}")
        # print(f"enc_outsize:{enc_outputs.size()}")
