...
if __name__ == '__main__':
    ...
    print(f"exp1 - Ablation Variants of SongDriver: Remove Weighted Factor")

    train_dataset = AiMusicDataset('dataset/all-half.pre.1.txt', 'data/melody_to_id.json', 'data/chord_to_id.json', args)
